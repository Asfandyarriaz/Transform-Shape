...
public class PlayerDataController : MonoBehaviour {
    ...
    public void HandleIncreamentData()
    {
        ...
        if (playerData.currentSelectLevel_ExpertMode < 1)
	        playerData.currentSelectLevel_ExpertMode = 1;
        if (playerData.LastUnlockedLevel_ExpertMode < 1)
	        playerData.LastUnlockedLevel_ExpertMode = 1;
        
        if (playerData.currentSelectLevel_FlyingMode < 1)
	        playerData.currentSelectLevel_FlyingMode = 1;
        if (playerData.LastUnlockedLevel_FlyingMode < 1)
	        playerData.LastUnlockedLevel_FlyingMode = 1;
        
        if (playerData.currentSelectLevel_UnderWaterMode < 1)
	        playerData.currentSelectLevel_UnderWaterMode = 1;
        if (playerData.LastUnlockedLevel_UnderWaterMode < 1)
	        playerData.LastUnlockedLevel_UnderWaterMode = 1;
    }
